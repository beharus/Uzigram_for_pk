  ...
  return (
    <>
      <NavLink to={props.url}>
        <div className=" w-20 font-firecode flex flex-col justify-center dark:focus:dark:bg-slate-700 cursor-pointer px-2 py-3 focus:bg-amber-700 focus:text-amber-400 dark:hover:bg-slate-700 dark:hover:text-slate-50 dark:focus:bg-slate-700 dark:focus:text-slate-50 dark:text-slate-400 hover:bg-amber-700 hover:text-amber-400 duration-200 ease-out h-18">
